...
DB_CONFIG = if ENV.fetch("DATABASE", "postgresql") == "postgresql"
              ...
              {
                adapter: "sqlite3",
                database: "lateral_associations_test.sqlite3",
              }
            end
...
# https://github.com/rails/rails/blob/bfd3cfdbfc38b25e53e5fe85f1c77a61c9c600b7/activerecord/lib/active_record/testing/query_assertions.rb#L42
module ActiveRecord
  module Assertions
